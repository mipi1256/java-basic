...
public class Phone {
   ...
   */
   ...
   // 생성자 선언!
   Phone() {
      System.out.println("기본 생성자 호출!"); // This will show when you called the class.
      // If you put value on each variable then when your Phone is called to another place
      // Then the value below will become the default for everything
      model = "폴더폰";
      color = "회색";
   ...
   /*
      ...
      2. 단, 생성자의 매개변수의 타입, 개수, 순서 중 하나가 달라야 중복을 인정합니다.
