...
public class DateExample {
   ...
   public static void main(String[] args) {
      ...
      long betweenDays = ChronoUnit.DAYS.between(b, f);
      System.out.println("between = " + betweenDays);
      long betweenMonths = ChronoUnit.MONTHS.between(b, f);
      System.out.println("between2 = " + betweenMonths);
      long betweenYears = ChronoUnit.YEARS.between(b, f);
      System.out.println("between3 = " + betweenYears);
      ...
      DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy년 MM월 dd일 E요일 a hh시 mm분 ss초"); // 오후 추가 12H Format
      DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("yyyy년 MM월 dd일 E요일 HH시 mm분 ss초"); // 24H FORMAT
