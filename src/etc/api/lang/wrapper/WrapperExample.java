...
public class WrapperExample {
   ...
   public static void main(String[] args) {
      ...
      // Integer v1 = new Integer(a); version 9 or older
      // Boolean v2 = new Boolean(b);

      // unboxing: 객체 타입으로 포장된 값을 기본 데이터 타입으로 풀어내는 과정. -> deprecated
      // int i = v1.intValue(); version 9 or older
      ...
      // Integer.parseInt("24.35"); -> This is an error because the decimal points are double.
