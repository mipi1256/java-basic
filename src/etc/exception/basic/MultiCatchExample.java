...
public class MultiCatchExample {
   ...
   public static void main(String[] args) {
      ...
      }// Exception should be at the end of the catch because it's the parent of all other problems.
      // If you put in on the top then there will an error, and it will override other problems.
